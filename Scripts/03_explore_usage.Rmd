...
The median number of interactions in this period is `{median(df_viz_unique_views$n_unique_views)`. Of the `r nrow(df_viz_unique_views)` views published on Tableau Server, `r n_no_views` have not been interacted with in the last 6 months. Another `n_1_views` have only been interacted with once, resulting in `r percent((n_no_views + n_1_views)/nrow(df_viz_unique_views), 1)` of developed/published views within OHA Tableau Server have been viewed 1 or less times in the last 6 months.
